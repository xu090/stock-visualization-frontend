...
function normalizeConcept(item = {}) {
  ...
  return {
    ...
    upCount: toNullableNumber(item.upCount),
    downCount: toNullableNumber(item.downCount),
    ...
    rtUpCount: toNullableNumber(item.upCount),
    rtDownCount: toNullableNumber(item.downCount),
  ...
  actions: {
    ...
    syncMarketDetail(detail) {
      ...
      return this.upsertConcept({
        ...
        upCount: detail?.upCount ?? current.upCount,
        downCount: detail?.downCount ?? current.downCount,
